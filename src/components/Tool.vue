<template>
  <div id="tool">
    <el-button class="start-button" @click="startHandler" type="warning" size="mini">{{
      running ? '停止' : '开始'
    }}</el-button>
    ...
    >
      <el-form ref="form" :model="form" label-width="80px" size="mini">
        ...
        <el-form-item label="自动停止">
          ...
          :step="1"
        >
        <i slot="suffix" style="margin-right: 10px;">秒</i>
      </el-input>
        </el-form-item>

        <el-form-item>
          <button class="lottery-button" @click.prevent="onSubmit">立即抽奖</button>
...
<style lang="scss">
.start-button.el-button--warning{
  font-size: 14px;
  font-weight: bold;
